  ...
  <xcontent :classname="'bg-light'">
    <span slot="title">
      <span class="icon is-middle">
        <i class="fa fa-home is-right-5"></i>
      </span>首页</span>

    <div slot="menu" class="tabs is-boxed" style="margin:10px 20px 0;">
      <ul class="is-left">
        <li :class="{'is-active':index===0}" @click="change(0)">
          <a>简介</a>
        </li>
        <li :class="{'is-active':index===1}" @click="change(1)">
          <a>布局</a>
        </li>
        <li :class="{'is-active':index===2}" @click="change(2)">
          <a>全局</a>
        </li>
        <li :class="{'is-active':index===3}" @click="change(3)">
          <a>缓存</a>
        </li>
      </ul>
    </div>
