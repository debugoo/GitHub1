...
(function($) {
  ...
  var init = function(tb, options) {
    ...
    createGrips = function(t) {
      ...
      th.each(function(i) {
        ...
        g
          ...
          .append('<div class="' + SIGNATURE + '"></div>');
        if (i == t.ln - 1) {
    ...
    onGripDragOver = function(e) {
      d
        .unbind("touchend." + SIGNATURE + " mouseup." + SIGNATURE)
      ...
      th.each(function(i) {
        ...
        if (!dc) {
          ...
          g
            ...
            .bind("touchstart mousedown", onGripMouseDown);
        } else {
